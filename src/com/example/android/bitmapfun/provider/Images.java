...
public class Images {
	 ...
	 * @throws IOException
	 */
	public static String GetLink(String inp){

		String myString = "";
		try {
			URL input = new URL(inp);
		...
		int start = myString.indexOf("viewer");
		start = myString.indexOf("img src", start);
		int end = myString.indexOf("onerror", start);
		String url = myString.substring(start + 9, end - 2);
		Log.d("ImageGridActivity","HelloNham"+String.valueOf(start)+" "+String.valueOf(end)+" "+url);
		return url;
	}
	...
	/*
	 * { try { a =
	 * GetLink("view-source:http://mangafox.me/manga/deus_x_makina/v02/c009/1.html"
	 * ); System.out.print(a); } catch (IOException e) { e.printStackTrace(); }
	 * }
	 */
	public final static String[] imageThumbUrls = new String[] { GetLink("http://mangafox.me/manga/deus_x_makina/v02/c009/1.html") };
	/*
